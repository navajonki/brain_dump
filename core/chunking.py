...
class AtomicChunker(TextChunker):
    """
    Backward compatibility class that aliases TextChunker.
    
    This class is maintained for backward compatibility with existing code that
    imports AtomicChunker. It is functionally identical to TextChunker.
    
    Note: This class is deprecated and will be removed in a future version.
    New code should use TextChunker directly.
    """
    
    def __init__(self, *args, **kwargs):
        """Initialize the AtomicChunker (now TextChunker)."""
        import warnings
        warnings.warn(
            "AtomicChunker is deprecated and will be removed in a future version. "
